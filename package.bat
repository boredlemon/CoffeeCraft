...
javac -sourcepath src src\com\tornukah\microcraft\Main.java -d out\production\Microcraft
...
jpackage --name MICROCRAFT --input out\artifacts\Microcraft_jar\ --main-jar Microcraft.jar --main-class com.tornukah.microcraft.Main --resource-dir res --icon res\icon.ico